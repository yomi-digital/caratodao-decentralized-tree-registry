...
task("add-member", "Add a member in the DAO.")
  .setAction(async (taskArgs) => {
    ...
    if (fs.existsSync("./deployments/wallaby/CaratoDaoRegistry.json")) {
      ...
      try {
        ...
        const data = await contractInterface.encodeFunctionData("fixMember", ["0xE6c30AD5AeE7AD22e9F39D51d67667587cdD05A1", true, [signature]])
